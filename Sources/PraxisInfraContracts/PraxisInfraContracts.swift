...
// - 补充本地 semantic search index 与 Accelerate 相似度计算的协作边界。
// - 保证 infra 只描述基础设施能力，不承接 CMP/TAP 业务规则。
// - 文件可继续拆分：CheckpointStore.swift、JournalStore.swift、ProjectionStore.swift、MessageBus.swift、DeliveryTruthStore.swift、EmbeddingStore.swift、SemanticSearchIndex.swift、LineageStore.swift。
