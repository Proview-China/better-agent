...
export function createTapBootstrapTmaProfile(
  ...
  return createAgentCapabilityProfile({
    ...
    notes: overrides.notes ?? "Bootstrap TMA can read, write bounded repo/doc/spreadsheet outputs, execute bounded remote commands, create tracker artifacts, edit, patch, diff, inspect git state, automate a bounded local browser, run restricted shell or shell sessions, run tests, manage todos, and generate repo-local docs.",
    metadata: {
